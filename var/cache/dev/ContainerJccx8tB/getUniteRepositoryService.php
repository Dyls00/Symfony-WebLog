 ...
 */
class getUniteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UniteRepository' shared autowired service.
     *
     * @return \App\Repository\UniteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UniteRepository.php';

        return $container->privates['App\\Repository\\UniteRepository'] = new \App\Repository\UniteRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
