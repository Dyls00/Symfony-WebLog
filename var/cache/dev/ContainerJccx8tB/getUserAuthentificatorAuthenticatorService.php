...
class getUserAuthentificatorAuthenticatorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Security'.\DIRECTORY_SEPARATOR.'UserAuthentificatorAuthenticator.php';

        return $container->privates['App\\Security\\UserAuthentificatorAuthenticator'] = new \App\Security\UserAuthentificatorAuthenticator(($container->services['router'] ?? self::getRouterService($container)));
    }
}
