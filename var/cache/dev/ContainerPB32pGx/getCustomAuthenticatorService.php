...
class getCustomAuthenticatorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['App\\Security\\CustomAuthenticator'] = new \App\Security\CustomAuthenticator(($container->privates['security.user.provider.concrete.user_provider'] ?? $container->load('getSecurity_User_Provider_Concrete_UserProviderService')), ($container->privates['security.user.provider.concrete.demandeur_provider'] ?? $container->load('getSecurity_User_Provider_Concrete_DemandeurProviderService')));
    }
}
